...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    test('explicit option', () => {
      const client = new ScaleWorkshop({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['SCALE_WORKSHOP_BASE_URL'] = 'https://example.com/from_env';
      const client = new ScaleWorkshop({ apiKey: 'My API Key' });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new ScaleWorkshop({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new ScaleWorkshop({ apiKey: 'My API Key' });
    expect(client2.maxRetries).toEqual(2);
  });

  test('with environment variable arguments', () => {
    // set options via env var
    process.env['AWESOME_COMPANY_API_KEY'] = 'My API Key';
    const client = new ScaleWorkshop();
  ...
  test('with overriden environment variable arguments', () => {
    // set options via env var
    process.env['AWESOME_COMPANY_API_KEY'] = 'another My API Key';
    const client = new ScaleWorkshop({ apiKey: 'My API Key' });
    expect(client.apiKey).toBe('My API Key');
  });
});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new ScaleWorkshop({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new ScaleWorkshop({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new ScaleWorkshop({ apiKey: 'My API Key', fetch: testFetch });
