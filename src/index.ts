...
export class ScaleWorkshop extends Core.APIClient {
   ...
   */
  constructor({ baseURL = Core.readEnv('SCALE_WORKSHOP_BASE_URL'), ...opts }: ClientOptions = {}) {
  ...
  myResourceName: API.MyResourceName = new API.MyResourceName(this);
...
export namespace ScaleWorkshop {
  ...
  export import MyResourceName = API.MyResourceName;
  export import MyResourceNameMyMethodResponse = API.MyResourceNameMyMethodResponse;
  export import MyResourceNameMyMethodParams = API.MyResourceNameMyMethodParams;
}
