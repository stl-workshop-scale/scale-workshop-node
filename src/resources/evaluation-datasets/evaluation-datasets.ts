...
export class EvaluationDatasets extends APIResource {
  ...
  ): Core.APIPromise<EvaluationDataset> {
  ...
  retrieve(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<EvaluationDatasetWithViews> {
   ...
   */
  delete(evaluationDatasetId: string, options?: Core.RequestOptions): Core.APIPromise<Shared.DeleteResponse> {
  ...
  approveBatch(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<AutoGeneratedDraftTestCaseApproveBatchResponse> {
  ...
  publish(
    ...
    options?: Core.RequestOptions,
  ): Core.APIPromise<PublishEvaluationDatasetDraftResponse>;
  publish(
    evaluationDatasetId: string,
    options?: Core.RequestOptions,
  ): Core.APIPromise<PublishEvaluationDatasetDraftResponse>;
...
export interface AutoGeneratedDraftTestCaseApproveBatchResponse {
  /**
   * List of responses for each of the input draft test cases.
   */
  autogenerated_draft_test_cases: Array<AutoGeneratedDraftTestCaseApproveBatchResponse.AutogeneratedDraftTestCase>;
...
export namespace AutoGeneratedDraftTestCaseApproveBatchResponse {
...
export interface EvaluationDatasetWithViews {
  /**
   * The unique identifier of the entity.
   */
  id: string;
  ...
  evaluation_dataset_versions?: Array<EvaluationDatasetWithViews.EvaluationDatasetVersion>;
...
export namespace EvaluationDatasetWithViews {
...
export interface PublishEvaluationDatasetDraftResponse {
  /**
   * List of responses for each of the input draft test cases.
   */
  autogenerated_draft_test_cases: Array<PublishEvaluationDatasetDraftResponse.AutogeneratedDraftTestCase>;
...
export namespace PublishEvaluationDatasetDraftResponse {
  export interface AutogeneratedDraftTestCase {
    /**
     * Draft test_case_id that has chunk_ids missing
     */
...
export interface EvaluationDatasetListResponse {
   ...
   */
  items: Array<EvaluationDatasetWithViews>;
...
export namespace EvaluationDatasets {
  export import AutoGeneratedDraftTestCaseApproveBatchResponse = EvaluationDatasetsAPI.AutoGeneratedDraftTestCaseApproveBatchResponse;
  export import EvaluationDataset = EvaluationDatasetsAPI.EvaluationDataset;
  export import EvaluationDatasetWithViews = EvaluationDatasetsAPI.EvaluationDatasetWithViews;
  export import PublishEvaluationDatasetDraftResponse = EvaluationDatasetsAPI.PublishEvaluationDatasetDraftResponse;
